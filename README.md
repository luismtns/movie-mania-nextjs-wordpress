# Movie Mania - Next.js WordPress Starter
...
## Credits
This project is based in [next-wpgraphql-basic-starter](https://github.com/colbyfayock/next-wpgraphql-basic-starter) by [Colby Fayock](https://github.com/colbyfayock).
